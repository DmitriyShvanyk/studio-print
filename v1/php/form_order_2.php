...
if (!empty($_POST)){ 
   ...
   $tel_order_2 = htmlspecialchars($_POST["tel_order_2"]);    
   //$picture = "";     
...
{
  $subject = '=?utf-8?B?'.base64_encode('Заказ с сайта STUDIO PRINT').'?=';
  $boundary = "--".md5(uniqid(time())); // генерируем разделитель
  
  $headers = "From:".htmlspecialchars($_POST["tel_order_2"])." <".htmlspecialchars($_POST["mail"]).">\r\n"; 
