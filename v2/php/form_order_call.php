...
if (!empty($_POST)){
   ...
   $fname_order_call = htmlspecialchars($_POST["fname_order_call"]);     
   $tel_order_call = htmlspecialchars($_POST["tel_order_call"]);    
   //$picture = "";     
  ...
  $body .= "ИМЯ:".$fname_order_call."\r\n";    
  $body .= "ТЕЛЕФОН:".$tel_order_call."\r\n";      
...
function send_mail($admin, $body, $email, $filepath, $filename)
{
  ...
  $headers = "From:".htmlspecialchars($_POST["fname_order_call"])." <".htmlspecialchars($_POST["mail"]).">\r\n"; 
